...
public class VocabularyNoteContoller {
	...
	private void updateWord() {
		...
		case 3:
			...
			//수정할 뜻 번호를 입력
			System.out.println("삭제할 뜻 번호 선택 : ");
			int num2 = sc.nextInt();
	...
	private void printSubMenuUpdate() {
		...
		System.out.println("2. 뜻수정");
		System.out.println("3. 뜻삭제");
