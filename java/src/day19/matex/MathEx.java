...
public class MathEx {
	...
	public static void main(String[] args) {
		...
		System.out.println(Math.ceil(1.29));//1.29의 소수점 첫번쨰 자리에서 올림
		System.out.println(Math.floor(1.29));//1.29의 소수점 첫번쨰 자리에서 내림
		System.out.println(Math.round(1.29));//1.29의 소수점 첫번쨰 자리에서 반올림
		...
		System.out.println(num);//1.29를 소수점 두번쨰 자리에서 반올림
	}
